...
def extract_frame(vid_item):
    ...
    """
    args, full_path, vid_path, vid_id, method, task, report_file = vid_item
    if '/' in vid_path:
...
def parse_args():
    ...
    parser.add_argument('--src_dir', type=str, default='', help='source video directory')
    parser.add_argument('--out_dir', type=str, default='', help='output rawframe directory')
    parser.add_argument(
        '--task',
        type=str,
        default='flow',
...
def extract_from_video(FRAME_CFGS):
    args = parse_args()
    args.src_dir=FRAME_CFGS['src_dir']
    args.out_dir=FRAME_CFGS['out_dir']
    args.task=FRAME_CFGS['task']
    args.level=FRAME_CFGS['level']
    args.ext=FRAME_CFGS['ext']
    args.new_short=FRAME_CFGS['new_short']
    args.use_opencv=FRAME_CFGS['use_opencv']
